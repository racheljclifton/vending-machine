...
import com.techelevator.vendingmachine.Item;
...
public class MenuTest {
	...
	//@Test
	//public void correctly_displays_items() {
		//Item itemOne = new Item(new String[] {"A1", "Potato Crisps", "3.05", "Chip"});
		//Item itemTwo = new Item(new String[] {"A2", "Stackers", "1.45", "Chip"});
		//Item itemThree = new Item(new String[] {"A3", "Grain Waves", "2.75", "Chip"});
		//List<Item> inventoryList = new ArrayList<>();
		//inventoryList.add(itemOne);
		//inventoryList.add(itemTwo);
		//inventoryList.add(itemThree);
		//Menu sut = new Menu(System.in, System.out);
		//String actual = sut.displayItems(inventoryList);
		//Assert.assertEquals("A1 Potato Crisps 3.05", sut.displayItems(inventoryList));
	//}
}
